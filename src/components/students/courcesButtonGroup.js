...
const CourcesButton = ({selectedCources, cources, courceStudents, students}) => {
        ...
        <div style={{ width: "100%", overflow: " auto ", display: "flex" }}>
            ...
            cources.map(cource => (
                <Button
                    ...
                    <span>{cource.name}<Badge color="secondary" style={{marginLeft: "4px"}}>{students && studentSameCource(cource)}</Badge></span>
                </Button>
            ))}
        </div>
    )
